...
import { updateStudent, closeForm } from '../features/studentSlice';
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className='form-group-container'>
          ...
          <div className='form-group'>
            ...
            <input type="text" name="batch" value={student.batch} onChange={handleChange} />
          </div>
        </div>
        <div className="buttons">
          <button type="button" className="cancel-button" onClick={() => dispatch(closeForm())}>
            Cancel
          </button>
